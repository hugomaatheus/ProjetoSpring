...
//	}
	...
	public String save(@ModelAttribute("reserva") Reserva reserva, HttpSession session,BindingResult result, ModelMap map) {
		funcionarioService.cadastrarReserva(reserva, (Funcionario) session.getAttribute("usuario"));
